...
print_getQuoteAsync_help() {
    echo ""
    echo -e "${BOLD}${WHITE}getQuoteAsync - Get margin details by ID${OFF}" | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e ""
    echo -e "Retrieves the details of a specific sales margin by its ID." | paste -sd' ' | fold -sw 80
    echo -e ""
    echo -e "${BOLD}${WHITE}Parameters${OFF}"
