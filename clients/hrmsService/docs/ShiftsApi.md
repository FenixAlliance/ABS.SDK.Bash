...
```bash
 createShiftAsync  tenantId=value  api-version=value x-api-version:value
```
...
```bash
 deleteShiftAsync  tenantId=value shiftId=value  api-version=value x-api-version:value
```
...
```bash
 getShiftByIdAsync  tenantId=value shiftId=value  api-version=value x-api-version:value
```
...
```bash
 getShiftsAsync  tenantId=value  api-version=value x-api-version:value
```
...
```bash
 getShiftsCountAsync  tenantId=value  api-version=value x-api-version:value
```
...
```bash
 updateShiftAsync  tenantId=value shiftId=value  api-version=value x-api-version:value
```
