...
```bash
 createSalaryAsync  tenantId=value  api-version=value x-api-version:value
```
...
```bash
 deleteSalaryAsync  tenantId=value salaryId=value  api-version=value x-api-version:value
```
...
------------- | ------------- | ------------- | -------------
 **tenantId** | **string** |  | [default to null]
 **salaryId** | **string** |  | [default to null]
 **apiVersion** | **string** |  | [optional] [default to null]
 **xApiVersion** | **string** |  | [optional] [default to null]
...
```bash
 getSalariesAsync  tenantId=value  api-version=value x-api-version:value
```
...
```bash
 getSalariesCountAsync  tenantId=value  api-version=value x-api-version:value
```
...
```bash
 getSalaryByIdAsync  tenantId=value salaryId=value  api-version=value x-api-version:value
```
...
```bash
 patchSalaryAsync  tenantId=value salaryId=value  api-version=value x-api-version:value
```
...
```bash
 updateSalaryAsync  tenantId=value salaryId=value  api-version=value x-api-version:value
```
