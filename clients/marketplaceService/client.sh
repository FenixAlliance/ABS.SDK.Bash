...
${BOLD}${WHITE}MarketplaceService command line client (API version 2.0.0.0)${OFF}
...
print_about() {
    echo ""
    echo -e "${BOLD}${WHITE}MarketplaceService command line client (API version 2.0.0.0)${OFF}"
    echo ""
...
print_version() {
    echo ""
    echo -e "${BOLD}MarketplaceService command line client (API version 2.0.0.0)${OFF}"
    echo ""
}
