...
```bash
 countWebContentsAsync  tenantId=value  api-version=value x-api-version:value
```
...
```bash
 createWebContentAsync  tenantId=value  api-version=value x-api-version:value
```
...
```bash
 deleteWebContentAsync  tenantId=value webContentId=value  api-version=value x-api-version:value
```
...
```bash
 getWebContentByIdAsync  tenantId=value webContentId=value  api-version=value x-api-version:value
```
...
```bash
 getWebContentsAsync  tenantId=value  api-version=value x-api-version:value
```
...
```bash
 updateWebContentAsync  tenantId=value webContentId=value  api-version=value x-api-version:value
```
