...
```bash
 createWorkstationAsync  tenantId=value  api-version=value x-api-version:value
```
...
```bash
 deleteWorkstationAsync  tenantId=value id=value  api-version=value x-api-version:value
```
...
```bash
 getWorkstationByIdAsync  tenantId=value id=value  api-version=value x-api-version:value
```
...
```bash
 getWorkstationsAsync  tenantId=value  api-version=value x-api-version:value
```
...
```bash
 getWorkstationsCountAsync  tenantId=value  api-version=value x-api-version:value
```
...
```bash
 patchWorkstationAsync  tenantId=value id=value  api-version=value x-api-version:value
```
...
```bash
 updateWorkstationAsync  tenantId=value id=value  api-version=value x-api-version:value
```
