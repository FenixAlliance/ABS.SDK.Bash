...
```bash
 getCartForTenantAsync tenantId=value  api-version=value x-api-version:value
```
...
```bash
 updateTenantAvatarAsync tenantId=value  api-version=value x-api-version:value
```
