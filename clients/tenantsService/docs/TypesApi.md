...
```bash
 createTenantType  tenantId=value  api-version=value x-api-version:value
```
...
```bash
 deleteTenantType  tenantId=value tenantTypeId=value  api-version=value x-api-version:value
```
...
------------- | ------------- | ------------- | -------------
 **tenantId** | **string** |  | [default to null]
 **tenantTypeId** | **string** |  | [default to null]
 **apiVersion** | **string** |  | [optional] [default to null]
 **xApiVersion** | **string** |  | [optional] [default to null]
...
```bash
 getTenantTypeById  tenantId=value tenantTypeId=value  api-version=value x-api-version:value
```
...
```bash
 getTenantTypes  tenantId=value  api-version=value x-api-version:value
```
...
```bash
 getTenantTypesCount  tenantId=value  api-version=value x-api-version:value
```
...
```bash
 patchTenantType  tenantId=value tenantTypeId=value  api-version=value x-api-version:value
```
...
```bash
 updateTenantType  tenantId=value tenantTypeId=value  api-version=value x-api-version:value
```
