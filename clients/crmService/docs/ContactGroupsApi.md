...
```bash
 createContactGroupAsync  tenantId=value  api-version=value x-api-version:value
```
...
```bash
 deleteContactGroupAsync  tenantId=value id=value  api-version=value x-api-version:value
```
...
```bash
 getContactGroupByIdAsync  tenantId=value id=value  api-version=value x-api-version:value
```
...
```bash
 getContactGroupsAsync  tenantId=value  api-version=value x-api-version:value
```
...
```bash
 getContactGroupsCountAsync  tenantId=value  api-version=value x-api-version:value
```
...
```bash
 patchContactGroupAsync  tenantId=value id=value  api-version=value x-api-version:value
```
...
```bash
 updateContactGroupAsync  tenantId=value id=value  api-version=value x-api-version:value
```
