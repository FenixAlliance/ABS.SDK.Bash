...
```bash
 createContactProfileAsync  tenantId=value  api-version=value x-api-version:value
```
...
```bash
 deleteContactProfileAsync  tenantId=value id=value  api-version=value x-api-version:value
```
...
```bash
 getContactProfileByIdAsync  tenantId=value id=value  api-version=value x-api-version:value
```
...
```bash
 getContactProfilesAsync  tenantId=value  api-version=value x-api-version:value
```
...
```bash
 getContactProfilesCountAsync  tenantId=value  api-version=value x-api-version:value
```
...
```bash
 getPartnerProfilesCountAsync  tenantId=value  api-version=value x-api-version:value
```
...
```bash
 getPatientProfilesCountAsync  tenantId=value  api-version=value x-api-version:value
```
...
```bash
 patchContactProfileAsync  tenantId=value id=value  api-version=value x-api-version:value
```
...
```bash
 updateContactProfileAsync  tenantId=value id=value  api-version=value x-api-version:value
```
