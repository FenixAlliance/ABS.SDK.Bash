...
case $state in
  ops)
    # Operations
    _values "Operations" \
            "apiV2UblServiceCreditNotesInvoiceIdGet[]"             "apiV2UblServiceDebitNotesInvoiceIdGet[]"             "apiV2UblServiceDespatchAdvicesShipmentIdGet[]"             "accountLogoutPost[]" \
            ...
            "resetPasswordPost[]" \
            "versionGet[]"             "apiV2UblServiceInvoicesInvoiceIdGet[]"             "apiV2UblServiceReceiptAdvicesItemRestockIdGet[]" \
