...
${BOLD}${WHITE}EmailTemplates command line client (API version 2.1.2.5401)${OFF}
...
print_about() {
    echo ""
    echo -e "${BOLD}${WHITE}EmailTemplates command line client (API version 2.1.2.5401)${OFF}"
    echo ""
...
print_version() {
    echo ""
    echo -e "${BOLD}EmailTemplates command line client (API version 2.1.2.5401)${OFF}"
    echo ""
}
