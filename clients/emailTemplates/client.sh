...
#
# This is a Bash client for EmailTemplates.
#
# LICENSE:
...
${BOLD}${WHITE}EmailTemplates command line client (API version 2.1.2.5532)${OFF}
...
print_about() {
    echo ""
    echo -e "${BOLD}${WHITE}EmailTemplates command line client (API version 2.1.2.5532)${OFF}"
    echo ""
...
print_version() {
    echo ""
    echo -e "${BOLD}EmailTemplates command line client (API version 2.1.2.5532)${OFF}"
    echo ""
}
