...
#
# This is a Bash client for LocationsService.
#
# LICENSE:
...
operation_parameters_minimum_occurrences["createLocationAsync:::tenantId"]=1
operation_parameters_minimum_occurrences["createLocationAsync:::LocationCreateDto"]=0
...
operation_parameters_minimum_occurrences["deleteLocationAsync:::tenantId"]=1
operation_parameters_minimum_occurrences["deleteLocationAsync:::locationId"]=1
...
operation_parameters_minimum_occurrences["getLocationAsync:::tenantId"]=1
operation_parameters_minimum_occurrences["getLocationAsync:::locationId"]=1
operation_parameters_minimum_occurrences["getLocationsAsync:::tenantId"]=1
operation_parameters_minimum_occurrences["getLocationsAsync:::LocationDtoCollectionQueryParameters"]=0
operation_parameters_minimum_occurrences["getLocationsCountAsync:::tenantId"]=1
operation_parameters_minimum_occurrences["getLocationsCountAsync:::LocationDtoCollectionQueryParameters"]=0
...
operation_parameters_minimum_occurrences["getWalletLocationsAsync:::LocationDtoCollectionQueryParameters"]=0
operation_parameters_minimum_occurrences["getWalletLocationsCountAsync:::walletId"]=1
operation_parameters_minimum_occurrences["getWalletLocationsCountAsync:::LocationDtoCollectionQueryParameters"]=0
...
operation_parameters_minimum_occurrences["patchLocationAsync:::PatchOperation"]=0
...
operation_parameters_minimum_occurrences["patchWalletLocationAsync:::PatchOperation"]=0
...
operation_parameters_maximum_occurrences["createLocationAsync:::tenantId"]=0
operation_parameters_maximum_occurrences["createLocationAsync:::LocationCreateDto"]=0
...
operation_parameters_maximum_occurrences["deleteLocationAsync:::tenantId"]=0
operation_parameters_maximum_occurrences["deleteLocationAsync:::locationId"]=0
...
operation_parameters_maximum_occurrences["getLocationAsync:::tenantId"]=0
operation_parameters_maximum_occurrences["getLocationAsync:::locationId"]=0
operation_parameters_maximum_occurrences["getLocationsAsync:::tenantId"]=0
operation_parameters_maximum_occurrences["getLocationsAsync:::LocationDtoCollectionQueryParameters"]=0
operation_parameters_maximum_occurrences["getLocationsCountAsync:::tenantId"]=0
operation_parameters_maximum_occurrences["getLocationsCountAsync:::LocationDtoCollectionQueryParameters"]=0
...
operation_parameters_maximum_occurrences["getWalletLocationsAsync:::LocationDtoCollectionQueryParameters"]=0
operation_parameters_maximum_occurrences["getWalletLocationsCountAsync:::walletId"]=0
operation_parameters_maximum_occurrences["getWalletLocationsCountAsync:::LocationDtoCollectionQueryParameters"]=0
...
operation_parameters_maximum_occurrences["patchLocationAsync:::PatchOperation"]=0
...
operation_parameters_maximum_occurrences["patchWalletLocationAsync:::PatchOperation"]=0
...
operation_parameters_collection_type["createLocationAsync:::tenantId"]=""
operation_parameters_collection_type["createLocationAsync:::LocationCreateDto"]=""
...
operation_parameters_collection_type["deleteLocationAsync:::tenantId"]=""
operation_parameters_collection_type["deleteLocationAsync:::locationId"]=""
...
operation_parameters_collection_type["getLocationAsync:::tenantId"]=""
operation_parameters_collection_type["getLocationAsync:::locationId"]=""
operation_parameters_collection_type["getLocationsAsync:::tenantId"]=""
operation_parameters_collection_type["getLocationsAsync:::LocationDtoCollectionQueryParameters"]=""
operation_parameters_collection_type["getLocationsCountAsync:::tenantId"]=""
operation_parameters_collection_type["getLocationsCountAsync:::LocationDtoCollectionQueryParameters"]=""
...
operation_parameters_collection_type["getWalletLocationsAsync:::LocationDtoCollectionQueryParameters"]=""
operation_parameters_collection_type["getWalletLocationsCountAsync:::walletId"]=""
operation_parameters_collection_type["getWalletLocationsCountAsync:::LocationDtoCollectionQueryParameters"]=""
...
operation_parameters_collection_type["patchLocationAsync:::PatchOperation"]=
...
operation_parameters_collection_type["patchWalletLocationAsync:::PatchOperation"]=
...
${BOLD}${WHITE}LocationsService command line client (API version 2.0.0.0)${OFF}
...
read -r -d '' ops <<EOF
  ${CYAN}createLocationAsync${OFF};Create Location
  ${CYAN}createWalletLocationAsync${OFF};Create Wallet Location
  ${CYAN}deleteLocationAsync${OFF};Delete Location
  ${CYAN}deleteWalletLocationAsync${OFF};Delete Wallet Location
  ${CYAN}getLocationAsync${OFF};Get Location
  ${CYAN}getLocationsAsync${OFF};Get Locations
  ${CYAN}getLocationsCountAsync${OFF};Get Locations Count
...
print_about() {
    echo ""
    echo -e "${BOLD}${WHITE}LocationsService command line client (API version 2.0.0.0)${OFF}"
    echo ""
...
print_version() {
    echo ""
    echo -e "${BOLD}LocationsService command line client (API version 2.0.0.0)${OFF}"
    echo ""
}
...
##############################################################################
#
# Print help for createLocationAsync operation
#
##############################################################################
print_createLocationAsync_help() {
    echo ""
    echo -e "${BOLD}${WHITE}createLocationAsync - Create Location${OFF}" | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e ""
    echo -e "Create a new location." | paste -sd' ' | fold -sw 80
    echo -e ""
    echo -e "${BOLD}${WHITE}Parameters${OFF}"
...
print_createWalletLocationAsync_help() {
    ...
    echo -e ""
    echo -e "Create a new location for a specific wallet." | paste -sd' ' | fold -sw 80
    echo -e ""
    echo -e "${BOLD}${WHITE}Parameters${OFF}"
...
##############################################################################
#
# Print help for deleteLocationAsync operation
#
##############################################################################
print_deleteLocationAsync_help() {
    echo ""
    echo -e "${BOLD}${WHITE}deleteLocationAsync - Delete Location${OFF}" | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e ""
    echo -e "Delete a specific location by ID." | paste -sd' ' | fold -sw 80
    echo -e ""
    echo -e "${BOLD}${WHITE}Parameters${OFF}"
    echo -e "  * ${GREEN}tenantId${OFF} ${BLUE}[string]${OFF} ${RED}(required)${OFF} ${CYAN}(default: null)${OFF} - ${YELLOW} Specify as: tenantId=value${OFF}" \
        | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
...
print_deleteWalletLocationAsync_help() {
    ...
    echo -e ""
    echo -e "Delete a specific location of a wallet." | paste -sd' ' | fold -sw 80
    echo -e ""
    echo -e "${BOLD}${WHITE}Parameters${OFF}"
    echo -e "  * ${GREEN}walletId${OFF} ${BLUE}[string]${OFF} ${RED}(required)${OFF} ${CYAN}(default: null)${OFF} -  ${YELLOW}Specify as: walletId=value${OFF}" | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e "  * ${GREEN}locationId${OFF} ${BLUE}[string]${OFF} ${RED}(required)${OFF} ${CYAN}(default: null)${OFF} -  ${YELLOW}Specify as: locationId=value${OFF}" | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
...
##############################################################################
#
# Print help for getLocationAsync operation
#
##############################################################################
print_getLocationAsync_help() {
    echo ""
    echo -e "${BOLD}${WHITE}getLocationAsync - Get Location${OFF}" | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e ""
    echo -e "Get details of a specific location by ID." | paste -sd' ' | fold -sw 80
    echo -e ""
    echo -e "${BOLD}${WHITE}Parameters${OFF}"
    echo -e "  * ${GREEN}tenantId${OFF} ${BLUE}[string]${OFF} ${RED}(required)${OFF} ${CYAN}(default: null)${OFF} - ${YELLOW} Specify as: tenantId=value${OFF}" \
        | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
...
##############################################################################
#
# Print help for getLocationsAsync operation
#
##############################################################################
print_getLocationsAsync_help() {
    echo ""
    echo -e "${BOLD}${WHITE}getLocationsAsync - Get Locations${OFF}" | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e ""
    echo -e "Get all locations with OData query support." | paste -sd' ' | fold -sw 80
    echo -e ""
    echo -e "${BOLD}${WHITE}Parameters${OFF}"
    echo -e "  * ${GREEN}tenantId${OFF} ${BLUE}[string]${OFF} ${RED}(required)${OFF} ${CYAN}(default: null)${OFF} - ${YELLOW} Specify as: tenantId=value${OFF}" \
        | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
...
##############################################################################
#
# Print help for getLocationsCountAsync operation
#
##############################################################################
print_getLocationsCountAsync_help() {
    echo ""
    echo -e "${BOLD}${WHITE}getLocationsCountAsync - Get Locations Count${OFF}" | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e ""
    echo -e "Get the count of locations with OData query support." | paste -sd' ' | fold -sw 80
    echo -e ""
    echo -e "${BOLD}${WHITE}Parameters${OFF}"
    echo -e "  * ${GREEN}tenantId${OFF} ${BLUE}[string]${OFF} ${RED}(required)${OFF} ${CYAN}(default: null)${OFF} - ${YELLOW} Specify as: tenantId=value${OFF}" \
        | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
...
print_getWalletLocationAsync_help() {
    ...
    echo -e ""
    echo -e "Get a specific location of a wallet by ID." | paste -sd' ' | fold -sw 80
    echo -e ""
    echo -e "${BOLD}${WHITE}Parameters${OFF}"
    echo -e "  * ${GREEN}walletId${OFF} ${BLUE}[string]${OFF} ${RED}(required)${OFF} ${CYAN}(default: null)${OFF} -  ${YELLOW}Specify as: walletId=value${OFF}" | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e "  * ${GREEN}locationId${OFF} ${BLUE}[string]${OFF} ${RED}(required)${OFF} ${CYAN}(default: null)${OFF} -  ${YELLOW}Specify as: locationId=value${OFF}" | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
...
print_getWalletLocationsAsync_help() {
    ...
    echo -e ""
    echo -e "Get locations for a specific wallet by ID." | paste -sd' ' | fold -sw 80
    echo -e ""
    echo -e "${BOLD}${WHITE}Parameters${OFF}"
    echo -e "  * ${GREEN}walletId${OFF} ${BLUE}[string]${OFF} ${RED}(required)${OFF} ${CYAN}(default: null)${OFF} -  ${YELLOW}Specify as: walletId=value${OFF}" | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e "  * ${GREEN}body${OFF} ${BLUE}[application/json,application/xml]${OFF}${OFF} - " | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
...
print_getWalletLocationsCountAsync_help() {
    ...
    echo -e ""
    echo -e "Get the count of locations for a specific wallet by ID." | paste -sd' ' | fold -sw 80
    echo -e ""
    echo -e "${BOLD}${WHITE}Parameters${OFF}"
    echo -e "  * ${GREEN}walletId${OFF} ${BLUE}[string]${OFF} ${RED}(required)${OFF} ${CYAN}(default: null)${OFF} -  ${YELLOW}Specify as: walletId=value${OFF}" | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e "  * ${GREEN}body${OFF} ${BLUE}[application/json,application/xml]${OFF}${OFF} - " | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
...
##############################################################################
#
# Print help for updateLocationAsync operation
#
##############################################################################
print_updateLocationAsync_help() {
    echo ""
    echo -e "${BOLD}${WHITE}updateLocationAsync - Update Location${OFF}" | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e ""
    echo -e "Update a specific location by ID." | paste -sd' ' | fold -sw 80
    echo -e ""
    echo -e "${BOLD}${WHITE}Parameters${OFF}"
    echo -e "  * ${GREEN}tenantId${OFF} ${BLUE}[string]${OFF} ${RED}(required)${OFF} ${CYAN}(default: null)${OFF} - ${YELLOW} Specify as: tenantId=value${OFF}" \
        | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
...
print_updateWalletLocationAsync_help() {
    ...
    echo -e ""
    echo -e "Update a specific location of a wallet." | paste -sd' ' | fold -sw 80
    echo -e ""
    echo -e "${BOLD}${WHITE}Parameters${OFF}"
    echo -e "  * ${GREEN}walletId${OFF} ${BLUE}[string]${OFF} ${RED}(required)${OFF} ${CYAN}(default: null)${OFF} -  ${YELLOW}Specify as: walletId=value${OFF}" | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e "  * ${GREEN}locationId${OFF} ${BLUE}[string]${OFF} ${RED}(required)${OFF} ${CYAN}(default: null)${OFF} -  ${YELLOW}Specify as: locationId=value${OFF}" | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
...
##############################################################################
#
# Call createLocationAsync operation
#
##############################################################################
call_createLocationAsync() {
    # ignore error about 'path_parameter_names' being unused; passed by reference
    # shellcheck disable=SC2034
    local path_parameter_names=()
    # ignore error about 'query_parameter_names' being unused; passed by reference
    ...
    if ! path=$(build_request_path "/api/v2/LocationsService/Locations" path_parameter_names query_parameter_names); then
        ERROR_MSG=$path
        exit 1
    fi
    local method="POST"
...
call_createWalletLocationAsync() {
    ...
    if ! path=$(build_request_path "/api/v2/LocationsService/Locations/wallet/{walletId}" path_parameter_names query_parameter_names); then
        ERROR_MSG=$path
        exit 1
    fi
    local method="POST"
...
##############################################################################
#
# Call deleteLocationAsync operation
#
##############################################################################
call_deleteLocationAsync() {
    # ignore error about 'path_parameter_names' being unused; passed by reference
    # shellcheck disable=SC2034
...
##############################################################################
#
# Call getLocationAsync operation
#
##############################################################################
call_getLocationAsync() {
    # ignore error about 'path_parameter_names' being unused; passed by reference
    # shellcheck disable=SC2034
    local path_parameter_names=(locationId)
    # ignore error about 'query_parameter_names' being unused; passed by reference
...
##############################################################################
#
# Call getLocationsAsync operation
#
##############################################################################
call_getLocationsAsync() {
    # ignore error about 'path_parameter_names' being unused; passed by reference
    # shellcheck disable=SC2034
    local path_parameter_names=()
    # ignore error about 'query_parameter_names' being unused; passed by reference
...
##############################################################################
#
# Call getLocationsCountAsync operation
#
##############################################################################
call_getLocationsCountAsync() {
    # ignore error about 'path_parameter_names' being unused; passed by reference
    # shellcheck disable=SC2034
    local path_parameter_names=()
    # ignore error about 'query_parameter_names' being unused; passed by reference
    ...
    if ! path=$(build_request_path "/api/v2/LocationsService/Locations/count" path_parameter_names query_parameter_names); then
        ERROR_MSG=$path
        exit 1
    fi
    local method="GET"
...
call_getWalletLocationsCountAsync() {
    ...
    if ! path=$(build_request_path "/api/v2/LocationsService/Locations/wallet/{walletId}/count" path_parameter_names query_parameter_names); then
        ERROR_MSG=$path
        exit 1
    fi
    local method="GET"
