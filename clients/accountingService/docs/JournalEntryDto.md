...
**journalName** | **string** |  | [optional] [default to null]
**journalCode** | **string** |  | [optional] [default to null]
**fiscalPeriodId** | **string** |  | [optional] [default to null]
**financialBookId** | **string** |  | [optional] [default to null]
**description** | **string** |  | [optional] [default to null]
**entryType** | **string** |  | [optional] [default to null]
**status** | **string** |  | [optional] [default to null]
**postingDate** | **string** |  | [optional] [default to null]
**isOpeningBalance** | **boolean** |  | [optional] [default to null]
**transactionCurrencyId** | **string** |  | [optional] [default to null]
**sourceDocumentType** | **string** |  | [optional] [default to null]
**sourceDocumentId** | **string** |  | [optional] [default to null]
**idempotencyKey** | **string** |  | [optional] [default to null]
**reversalOfJournalEntryId** | **string** |  | [optional] [default to null]
...
**totalDebit** | **float** |  | [optional] [readonly] [default to null]
