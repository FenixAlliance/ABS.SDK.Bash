...
```bash
 closeFiscalPeriod  tenantId=value fiscalPeriodId=value  api-version=value x-api-version:value
```
...
```bash
 openFiscalPeriod  tenantId=value fiscalPeriodId=value  api-version=value x-api-version:value
```
