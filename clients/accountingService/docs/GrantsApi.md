...
```bash
 createGrantAsync  tenantId=value  api-version=value x-api-version:value
```
...
```bash
 deleteGrantAsync  tenantId=value grantId=value  api-version=value x-api-version:value
```
...
```bash
 getGrantDetailsAsync  tenantId=value grantId=value  api-version=value x-api-version:value
```
...
```bash
 getGrantsAsync  tenantId=value  api-version=value x-api-version:value
```
...
```bash
 getGrantsCountAsync  tenantId=value  api-version=value x-api-version:value
```
...
```bash
 patchGrantAsync  tenantId=value grantId=value  api-version=value x-api-version:value
```
...
```bash
 updateGrantAsync  tenantId=value grantId=value  api-version=value x-api-version:value
```
