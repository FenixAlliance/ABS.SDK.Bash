...
```bash
 createTaxRate  tenantId=value  api-version=value x-api-version:value
```
...
```bash
 deleteTaxRate  tenantId=value id=value  api-version=value x-api-version:value
```
...
```bash
 getTaxRate  tenantId=value id=value  api-version=value x-api-version:value
```
...
```bash
 getTaxRates  tenantId=value  api-version=value x-api-version:value
```
...
```bash
 getTaxRatesCount  tenantId=value  api-version=value x-api-version:value
```
...
```bash
 updateTaxRate  tenantId=value id=value  api-version=value x-api-version:value
```
