...
```bash
 getPricingRuleById  tenantId=value pricingRuleId=value  api-version=value x-api-version:value
```
...
```bash
 getPricingRulesCountAsync  tenantId=value  api-version=value x-api-version:value
```
