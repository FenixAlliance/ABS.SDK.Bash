...
```bash
 getPriceListPricesCountAsync  tenantId=value priceListId=value
```
...
```bash
 patchPriceListAsync  tenantId=value priceListId=value
```
...
```bash
 patchPriceListPriceAsync  tenantId=value priceListId=value priceId=value
```
