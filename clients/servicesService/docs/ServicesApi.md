...
```bash
 createServiceAsync  tenantId=value  api-version=value x-api-version:value
```
...
```bash
 deleteServiceAsync  tenantId=value serviceId=value  api-version=value x-api-version:value
```
...
```bash
 getServiceByIdAsync  tenantId=value serviceId=value  api-version=value x-api-version:value
```
...
```bash
 getServicesAsync  tenantId=value  api-version=value x-api-version:value
```
...
```bash
 getServicesCountAsync  tenantId=value  api-version=value x-api-version:value
```
...
```bash
 updateServiceAsync  tenantId=value serviceId=value  api-version=value x-api-version:value
```
