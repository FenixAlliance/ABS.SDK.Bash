...
#
# This is a Bash client for SubscriptionsService.
#
# LICENSE:
...
operation_parameters_minimum_occurrences["createSubscriptionPlanAsync:::tenantId"]=1
operation_parameters_minimum_occurrences["createSubscriptionPlanAsync:::api-version"]=0
operation_parameters_minimum_occurrences["createSubscriptionPlanAsync:::x-api-version"]=0
operation_parameters_minimum_occurrences["createSubscriptionPlanAsync:::SubscriptionPlanCreateDto"]=0
operation_parameters_minimum_occurrences["deleteSubscriptionPlanAsync:::tenantId"]=1
operation_parameters_minimum_occurrences["deleteSubscriptionPlanAsync:::planId"]=1
operation_parameters_minimum_occurrences["deleteSubscriptionPlanAsync:::api-version"]=0
operation_parameters_minimum_occurrences["deleteSubscriptionPlanAsync:::x-api-version"]=0
operation_parameters_minimum_occurrences["getSubscriptionPlanByIdAsync:::tenantId"]=1
operation_parameters_minimum_occurrences["getSubscriptionPlanByIdAsync:::planId"]=1
operation_parameters_minimum_occurrences["getSubscriptionPlanByIdAsync:::api-version"]=0
operation_parameters_minimum_occurrences["getSubscriptionPlanByIdAsync:::x-api-version"]=0
...
operation_parameters_minimum_occurrences["updateSubscriptionPlanAsync:::x-api-version"]=0
operation_parameters_minimum_occurrences["updateSubscriptionPlanAsync:::SubscriptionPlanUpdateDto"]=0
operation_parameters_minimum_occurrences["createSubscriptionAsync:::tenantId"]=1
operation_parameters_minimum_occurrences["createSubscriptionAsync:::api-version"]=0
operation_parameters_minimum_occurrences["createSubscriptionAsync:::x-api-version"]=0
operation_parameters_minimum_occurrences["createSubscriptionAsync:::SubscriptionCreateDto"]=0
operation_parameters_minimum_occurrences["deleteSubscriptionAsync:::tenantId"]=1
operation_parameters_minimum_occurrences["deleteSubscriptionAsync:::subscriptionId"]=1
operation_parameters_minimum_occurrences["deleteSubscriptionAsync:::api-version"]=0
operation_parameters_minimum_occurrences["deleteSubscriptionAsync:::x-api-version"]=0
operation_parameters_minimum_occurrences["getSubscriptionByIdAsync:::tenantId"]=1
operation_parameters_minimum_occurrences["getSubscriptionByIdAsync:::subscriptionId"]=1
operation_parameters_minimum_occurrences["getSubscriptionByIdAsync:::api-version"]=0
operation_parameters_minimum_occurrences["getSubscriptionByIdAsync:::x-api-version"]=0
...
operation_parameters_minimum_occurrences["updateSubscriptionAsync:::x-api-version"]=0
operation_parameters_minimum_occurrences["updateSubscriptionAsync:::SubscriptionUpdateDto"]=0
...
operation_parameters_maximum_occurrences["createSubscriptionPlanAsync:::tenantId"]=0
operation_parameters_maximum_occurrences["createSubscriptionPlanAsync:::api-version"]=0
operation_parameters_maximum_occurrences["createSubscriptionPlanAsync:::x-api-version"]=0
operation_parameters_maximum_occurrences["createSubscriptionPlanAsync:::SubscriptionPlanCreateDto"]=0
operation_parameters_maximum_occurrences["deleteSubscriptionPlanAsync:::tenantId"]=0
operation_parameters_maximum_occurrences["deleteSubscriptionPlanAsync:::planId"]=0
operation_parameters_maximum_occurrences["deleteSubscriptionPlanAsync:::api-version"]=0
operation_parameters_maximum_occurrences["deleteSubscriptionPlanAsync:::x-api-version"]=0
operation_parameters_maximum_occurrences["getSubscriptionPlanByIdAsync:::tenantId"]=0
operation_parameters_maximum_occurrences["getSubscriptionPlanByIdAsync:::planId"]=0
operation_parameters_maximum_occurrences["getSubscriptionPlanByIdAsync:::api-version"]=0
operation_parameters_maximum_occurrences["getSubscriptionPlanByIdAsync:::x-api-version"]=0
...
operation_parameters_maximum_occurrences["updateSubscriptionPlanAsync:::x-api-version"]=0
operation_parameters_maximum_occurrences["updateSubscriptionPlanAsync:::SubscriptionPlanUpdateDto"]=0
operation_parameters_maximum_occurrences["createSubscriptionAsync:::tenantId"]=0
operation_parameters_maximum_occurrences["createSubscriptionAsync:::api-version"]=0
operation_parameters_maximum_occurrences["createSubscriptionAsync:::x-api-version"]=0
operation_parameters_maximum_occurrences["createSubscriptionAsync:::SubscriptionCreateDto"]=0
operation_parameters_maximum_occurrences["deleteSubscriptionAsync:::tenantId"]=0
operation_parameters_maximum_occurrences["deleteSubscriptionAsync:::subscriptionId"]=0
operation_parameters_maximum_occurrences["deleteSubscriptionAsync:::api-version"]=0
operation_parameters_maximum_occurrences["deleteSubscriptionAsync:::x-api-version"]=0
operation_parameters_maximum_occurrences["getSubscriptionByIdAsync:::tenantId"]=0
operation_parameters_maximum_occurrences["getSubscriptionByIdAsync:::subscriptionId"]=0
operation_parameters_maximum_occurrences["getSubscriptionByIdAsync:::api-version"]=0
operation_parameters_maximum_occurrences["getSubscriptionByIdAsync:::x-api-version"]=0
...
operation_parameters_maximum_occurrences["updateSubscriptionAsync:::x-api-version"]=0
operation_parameters_maximum_occurrences["updateSubscriptionAsync:::SubscriptionUpdateDto"]=0
...
operation_parameters_collection_type["createSubscriptionPlanAsync:::tenantId"]=""
operation_parameters_collection_type["createSubscriptionPlanAsync:::api-version"]=""
operation_parameters_collection_type["createSubscriptionPlanAsync:::x-api-version"]=""
operation_parameters_collection_type["createSubscriptionPlanAsync:::SubscriptionPlanCreateDto"]=""
operation_parameters_collection_type["deleteSubscriptionPlanAsync:::tenantId"]=""
operation_parameters_collection_type["deleteSubscriptionPlanAsync:::planId"]=""
operation_parameters_collection_type["deleteSubscriptionPlanAsync:::api-version"]=""
operation_parameters_collection_type["deleteSubscriptionPlanAsync:::x-api-version"]=""
operation_parameters_collection_type["getSubscriptionPlanByIdAsync:::tenantId"]=""
operation_parameters_collection_type["getSubscriptionPlanByIdAsync:::planId"]=""
operation_parameters_collection_type["getSubscriptionPlanByIdAsync:::api-version"]=""
operation_parameters_collection_type["getSubscriptionPlanByIdAsync:::x-api-version"]=""
...
operation_parameters_collection_type["updateSubscriptionPlanAsync:::x-api-version"]=""
operation_parameters_collection_type["updateSubscriptionPlanAsync:::SubscriptionPlanUpdateDto"]=""
operation_parameters_collection_type["createSubscriptionAsync:::tenantId"]=""
operation_parameters_collection_type["createSubscriptionAsync:::api-version"]=""
operation_parameters_collection_type["createSubscriptionAsync:::x-api-version"]=""
operation_parameters_collection_type["createSubscriptionAsync:::SubscriptionCreateDto"]=""
operation_parameters_collection_type["deleteSubscriptionAsync:::tenantId"]=""
operation_parameters_collection_type["deleteSubscriptionAsync:::subscriptionId"]=""
operation_parameters_collection_type["deleteSubscriptionAsync:::api-version"]=""
operation_parameters_collection_type["deleteSubscriptionAsync:::x-api-version"]=""
operation_parameters_collection_type["getSubscriptionByIdAsync:::tenantId"]=""
operation_parameters_collection_type["getSubscriptionByIdAsync:::subscriptionId"]=""
operation_parameters_collection_type["getSubscriptionByIdAsync:::api-version"]=""
operation_parameters_collection_type["getSubscriptionByIdAsync:::x-api-version"]=""
...
operation_parameters_collection_type["updateSubscriptionAsync:::x-api-version"]=""
operation_parameters_collection_type["updateSubscriptionAsync:::SubscriptionUpdateDto"]=""
...
${BOLD}${WHITE}SubscriptionsService command line client (API version 2.0.0.0)${OFF}
...
echo "  $ops" | column -t -s ';'
    echo ""
    echo -e "${BOLD}${WHITE}[subscriptionPlans]${OFF}"
read -r -d '' ops <<EOF
  ${CYAN}createSubscriptionPlanAsync${OFF};Create a subscription plan
  ${CYAN}deleteSubscriptionPlanAsync${OFF};Delete a subscription plan
...
echo "  $ops" | column -t -s ';'
    echo ""
    echo -e "${BOLD}${WHITE}[subscriptions]${OFF}"
read -r -d '' ops <<EOF
  ${CYAN}createSubscriptionAsync${OFF};Create a subscription
  ${CYAN}deleteSubscriptionAsync${OFF};Delete a subscription
...
print_about() {
    echo ""
    echo -e "${BOLD}${WHITE}SubscriptionsService command line client (API version 2.0.0.0)${OFF}"
    echo ""
...
print_version() {
    echo ""
    echo -e "${BOLD}SubscriptionsService command line client (API version 2.0.0.0)${OFF}"
    echo ""
}
...
##############################################################################
#
# Print help for createSubscriptionPlanAsync operation
#
##############################################################################
print_createSubscriptionPlanAsync_help() {
    echo ""
    echo -e "${BOLD}${WHITE}createSubscriptionPlanAsync - Create a subscription plan${OFF}" | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e ""
    echo -e "Creates a new subscription plan for the specified tenant." | paste -sd' ' | fold -sw 80
    echo -e ""
    echo -e "${BOLD}${WHITE}Parameters${OFF}"
...
##############################################################################
#
# Print help for deleteSubscriptionPlanAsync operation
#
##############################################################################
print_deleteSubscriptionPlanAsync_help() {
    echo ""
    echo -e "${BOLD}${WHITE}deleteSubscriptionPlanAsync - Delete a subscription plan${OFF}" | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e ""
    echo -e "Deletes a subscription plan by its identifier." | paste -sd' ' | fold -sw 80
    echo -e ""
    echo -e "${BOLD}${WHITE}Parameters${OFF}"
    echo -e "  * ${GREEN}tenantId${OFF} ${BLUE}[string]${OFF} ${RED}(required)${OFF} ${CYAN}(default: null)${OFF} - ${YELLOW} Specify as: tenantId=value${OFF}" \
        | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
...
##############################################################################
#
# Print help for getSubscriptionPlanByIdAsync operation
#
##############################################################################
print_getSubscriptionPlanByIdAsync_help() {
    echo ""
    echo -e "${BOLD}${WHITE}getSubscriptionPlanByIdAsync - Get a subscription plan by ID${OFF}" | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e ""
    echo -e "Retrieves a subscription plan by its identifier." | paste -sd' ' | fold -sw 80
    echo -e ""
    echo -e "${BOLD}${WHITE}Parameters${OFF}"
    echo -e "  * ${GREEN}tenantId${OFF} ${BLUE}[string]${OFF} ${RED}(required)${OFF} ${CYAN}(default: null)${OFF} - ${YELLOW} Specify as: tenantId=value${OFF}" \
        | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
...
##############################################################################
#
# Print help for getSubscriptionPlansAsync operation
#
##############################################################################
print_getSubscriptionPlansAsync_help() {
    echo ""
    echo -e "${BOLD}${WHITE}getSubscriptionPlansAsync - Get all subscription plans${OFF}" | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e ""
    echo -e "Retrieves all subscription plans for the specified tenant." | paste -sd' ' | fold -sw 80
    echo -e ""
    echo -e "${BOLD}${WHITE}Parameters${OFF}"
    echo -e "  * ${GREEN}tenantId${OFF} ${BLUE}[string]${OFF} ${RED}(required)${OFF} ${CYAN}(default: null)${OFF} - ${YELLOW} Specify as: tenantId=value${OFF}" \
        | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
...
##############################################################################
#
# Print help for getSubscriptionPlansCountAsync operation
#
##############################################################################
print_getSubscriptionPlansCountAsync_help() {
    echo ""
    echo -e "${BOLD}${WHITE}getSubscriptionPlansCountAsync - Get subscription plans count${OFF}" | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e ""
    echo -e "Returns the count of subscription plans for the specified tenant." | paste -sd' ' | fold -sw 80
    echo -e ""
    echo -e "${BOLD}${WHITE}Parameters${OFF}"
    echo -e "  * ${GREEN}tenantId${OFF} ${BLUE}[string]${OFF} ${RED}(required)${OFF} ${CYAN}(default: null)${OFF} - ${YELLOW} Specify as: tenantId=value${OFF}" \
        | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
...
#
##############################################################################
print_updateSubscriptionPlanAsync_help() {
    echo ""
    echo -e "${BOLD}${WHITE}updateSubscriptionPlanAsync - Update a subscription plan${OFF}" | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e ""
    echo -e "Updates an existing subscription plan." | paste -sd' ' | fold -sw 80
    echo -e ""
    echo -e "${BOLD}${WHITE}Parameters${OFF}"
    echo -e "  * ${GREEN}tenantId${OFF} ${BLUE}[string]${OFF} ${RED}(required)${OFF} ${CYAN}(default: null)${OFF} - ${YELLOW} Specify as: tenantId=value${OFF}" \
        | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
...
##############################################################################
#
# Print help for createSubscriptionAsync operation
#
##############################################################################
print_createSubscriptionAsync_help() {
    echo ""
    echo -e "${BOLD}${WHITE}createSubscriptionAsync - Create a subscription${OFF}" | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e ""
    echo -e "Creates a new subscription for the specified tenant." | paste -sd' ' | fold -sw 80
    echo -e ""
    echo -e "${BOLD}${WHITE}Parameters${OFF}"
    echo -e "  * ${GREEN}tenantId${OFF} ${BLUE}[string]${OFF} ${RED}(required)${OFF} ${CYAN}(default: null)${OFF} - ${YELLOW} Specify as: tenantId=value${OFF}" \
        | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
...
##############################################################################
#
# Print help for deleteSubscriptionAsync operation
#
##############################################################################
print_deleteSubscriptionAsync_help() {
    echo ""
    echo -e "${BOLD}${WHITE}deleteSubscriptionAsync - Delete a subscription${OFF}" | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e ""
    echo -e "Deletes a subscription by its identifier." | paste -sd' ' | fold -sw 80
    echo -e ""
    echo -e "${BOLD}${WHITE}Parameters${OFF}"
    echo -e "  * ${GREEN}tenantId${OFF} ${BLUE}[string]${OFF} ${RED}(required)${OFF} ${CYAN}(default: null)${OFF} - ${YELLOW} Specify as: tenantId=value${OFF}" \
        | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
...
##############################################################################
#
# Print help for getSubscriptionByIdAsync operation
#
##############################################################################
print_getSubscriptionByIdAsync_help() {
    echo ""
    echo -e "${BOLD}${WHITE}getSubscriptionByIdAsync - Get a subscription by ID${OFF}" | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e ""
    echo -e "Retrieves a subscription by its identifier." | paste -sd' ' | fold -sw 80
    echo -e ""
    echo -e "${BOLD}${WHITE}Parameters${OFF}"
    echo -e "  * ${GREEN}tenantId${OFF} ${BLUE}[string]${OFF} ${RED}(required)${OFF} ${CYAN}(default: null)${OFF} - ${YELLOW} Specify as: tenantId=value${OFF}" \
        | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
...
##############################################################################
#
# Print help for getSubscriptionsAsync operation
#
##############################################################################
print_getSubscriptionsAsync_help() {
    echo ""
    echo -e "${BOLD}${WHITE}getSubscriptionsAsync - Get all subscriptions${OFF}" | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e ""
    echo -e "Retrieves all subscriptions for the specified tenant." | paste -sd' ' | fold -sw 80
    echo -e ""
    echo -e "${BOLD}${WHITE}Parameters${OFF}"
    echo -e "  * ${GREEN}tenantId${OFF} ${BLUE}[string]${OFF} ${RED}(required)${OFF} ${CYAN}(default: null)${OFF} - ${YELLOW} Specify as: tenantId=value${OFF}" \
        | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
...
##############################################################################
#
# Print help for getSubscriptionsCountAsync operation
#
##############################################################################
print_getSubscriptionsCountAsync_help() {
    echo ""
    echo -e "${BOLD}${WHITE}getSubscriptionsCountAsync - Get subscriptions count${OFF}" | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e ""
    echo -e "Returns the count of subscriptions for the specified tenant." | paste -sd' ' | fold -sw 80
    echo -e ""
    echo -e "${BOLD}${WHITE}Parameters${OFF}"
    echo -e "  * ${GREEN}tenantId${OFF} ${BLUE}[string]${OFF} ${RED}(required)${OFF} ${CYAN}(default: null)${OFF} - ${YELLOW} Specify as: tenantId=value${OFF}" \
        | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
...
##############################################################################
#
# Print help for updateSubscriptionAsync operation
#
##############################################################################
print_updateSubscriptionAsync_help() {
    echo ""
    echo -e "${BOLD}${WHITE}updateSubscriptionAsync - Update a subscription${OFF}" | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e ""
    echo -e "Updates an existing subscription." | paste -sd' ' | fold -sw 80
    echo -e ""
    echo -e "${BOLD}${WHITE}Parameters${OFF}"
    echo -e "  * ${GREEN}tenantId${OFF} ${BLUE}[string]${OFF} ${RED}(required)${OFF} ${CYAN}(default: null)${OFF} - ${YELLOW} Specify as: tenantId=value${OFF}" \
        | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
...
##############################################################################
#
# Call createSubscriptionPlanAsync operation
#
##############################################################################
call_createSubscriptionPlanAsync() {
    # ignore error about 'path_parameter_names' being unused; passed by reference
    # shellcheck disable=SC2034
    local path_parameter_names=()
    # ignore error about 'query_parameter_names' being unused; passed by reference
    ...
    if ! path=$(build_request_path "/api/v2/SubscriptionsService/SubscriptionPlans" path_parameter_names query_parameter_names); then
        ERROR_MSG=$path
        exit 1
    fi
    local method="POST"
...
##############################################################################
#
# Call deleteSubscriptionPlanAsync operation
#
##############################################################################
call_deleteSubscriptionPlanAsync() {
    # ignore error about 'path_parameter_names' being unused; passed by reference
    # shellcheck disable=SC2034
...
##############################################################################
#
# Call getSubscriptionPlanByIdAsync operation
#
##############################################################################
call_getSubscriptionPlanByIdAsync() {
    # ignore error about 'path_parameter_names' being unused; passed by reference
    # shellcheck disable=SC2034
    local path_parameter_names=(planId)
    # ignore error about 'query_parameter_names' being unused; passed by reference
...
##############################################################################
#
# Call getSubscriptionPlansAsync operation
#
##############################################################################
call_getSubscriptionPlansAsync() {
    # ignore error about 'path_parameter_names' being unused; passed by reference
    # shellcheck disable=SC2034
    local path_parameter_names=()
    # ignore error about 'query_parameter_names' being unused; passed by reference
...
##############################################################################
#
# Call getSubscriptionPlansCountAsync operation
#
##############################################################################
call_getSubscriptionPlansCountAsync() {
    ...
    if ! path=$(build_request_path "/api/v2/SubscriptionsService/SubscriptionPlans/Count" path_parameter_names query_parameter_names); then
        ERROR_MSG=$path
        exit 1
    fi
    local method="GET"
...
##############################################################################
#
# Call createSubscriptionAsync operation
#
##############################################################################
call_createSubscriptionAsync() {
    # ignore error about 'path_parameter_names' being unused; passed by reference
    # shellcheck disable=SC2034
    local path_parameter_names=()
    # ignore error about 'query_parameter_names' being unused; passed by reference
    ...
    if ! path=$(build_request_path "/api/v2/SubscriptionsService/Subscriptions" path_parameter_names query_parameter_names); then
        ERROR_MSG=$path
        exit 1
    fi
    local method="POST"
...
##############################################################################
#
# Call deleteSubscriptionAsync operation
#
##############################################################################
call_deleteSubscriptionAsync() {
    # ignore error about 'path_parameter_names' being unused; passed by reference
    # shellcheck disable=SC2034
...
##############################################################################
#
# Call getSubscriptionByIdAsync operation
#
##############################################################################
call_getSubscriptionByIdAsync() {
    # ignore error about 'path_parameter_names' being unused; passed by reference
    # shellcheck disable=SC2034
    local path_parameter_names=(subscriptionId)
    # ignore error about 'query_parameter_names' being unused; passed by reference
...
##############################################################################
#
# Call getSubscriptionsAsync operation
#
##############################################################################
call_getSubscriptionsAsync() {
    # ignore error about 'path_parameter_names' being unused; passed by reference
    # shellcheck disable=SC2034
    local path_parameter_names=()
    # ignore error about 'query_parameter_names' being unused; passed by reference
...
##############################################################################
#
# Call getSubscriptionsCountAsync operation
#
##############################################################################
call_getSubscriptionsCountAsync() {
    ...
    if ! path=$(build_request_path "/api/v2/SubscriptionsService/Subscriptions/Count" path_parameter_names query_parameter_names); then
        ERROR_MSG=$path
        exit 1
    fi
    local method="GET"
