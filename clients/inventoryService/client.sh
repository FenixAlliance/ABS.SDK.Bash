...
${BOLD}${WHITE}InventoryService command line client (API version 2.1.2.5532)${OFF}
...
print_about() {
    echo ""
    echo -e "${BOLD}${WHITE}InventoryService command line client (API version 2.1.2.5532)${OFF}"
    echo ""
...
print_version() {
    echo ""
    echo -e "${BOLD}InventoryService command line client (API version 2.1.2.5532)${OFF}"
    echo ""
}
