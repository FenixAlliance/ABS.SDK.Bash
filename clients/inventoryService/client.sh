...
operation_parameters_minimum_occurrences["getInventoryDetailsAsync:::stockItemId"]=1
operation_parameters_minimum_occurrences["getInventoryDetailsAsync:::api-version"]=0
operation_parameters_minimum_occurrences["getInventoryDetailsAsync:::x-api-version"]=0
...
operation_parameters_maximum_occurrences["getInventoryDetailsAsync:::stockItemId"]=0
operation_parameters_maximum_occurrences["getInventoryDetailsAsync:::api-version"]=0
operation_parameters_maximum_occurrences["getInventoryDetailsAsync:::x-api-version"]=0
...
operation_parameters_collection_type["getInventoryDetailsAsync:::stockItemId"]=""
operation_parameters_collection_type["getInventoryDetailsAsync:::api-version"]=""
operation_parameters_collection_type["getInventoryDetailsAsync:::x-api-version"]=""
...
${BOLD}${WHITE}InventoryService command line client (API version 2.1.2.5401)${OFF}
...
read -r -d '' ops <<EOF
  ${CYAN}getInventoryDetailsAsync${OFF};Get inventory details for a stock item
EOF
echo "  $ops" | column -t -s ';'
    echo ""
...
print_about() {
    echo ""
    echo -e "${BOLD}${WHITE}InventoryService command line client (API version 2.1.2.5401)${OFF}"
    echo ""
...
print_version() {
    echo ""
    echo -e "${BOLD}InventoryService command line client (API version 2.1.2.5401)${OFF}"
    echo ""
}
...
##############################################################################
#
# Print help for getInventoryDetailsAsync operation
#
##############################################################################
print_getInventoryDetailsAsync_help() {
    echo ""
    echo -e "${BOLD}${WHITE}getInventoryDetailsAsync - Get inventory details for a stock item${OFF}" | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e ""
    echo -e "Retrieves the inventory details for a specific stock item by its ID." | paste -sd' ' | fold -sw 80
    echo -e ""
    echo -e "${BOLD}${WHITE}Parameters${OFF}"
...
##############################################################################
#
# Call getInventoryDetailsAsync operation
#
##############################################################################
call_getInventoryDetailsAsync() {
    # ignore error about 'path_parameter_names' being unused; passed by reference
    # shellcheck disable=SC2034
...
case $key in
    ...
    operation="getInventoryDetailsAsync"
    ;;
    *==*)
