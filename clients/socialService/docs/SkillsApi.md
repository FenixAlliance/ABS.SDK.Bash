...
```bash
 createSkillAsync  tenantId=value  api-version=value x-api-version:value
```
...
```bash
 deleteSkillAsync  tenantId=value skillId=value  api-version=value x-api-version:value
```
...
------------- | ------------- | ------------- | -------------
 **tenantId** | **string** |  | [default to null]
 **skillId** | **string** |  | [default to null]
 **apiVersion** | **string** |  | [optional] [default to null]
 **xApiVersion** | **string** |  | [optional] [default to null]
...
```bash
 getSkillByIdAsync  tenantId=value skillId=value  api-version=value x-api-version:value
```
...
```bash
 getSkillsAsync  tenantId=value  api-version=value x-api-version:value
```
...
```bash
 getSkillsCountAsync  tenantId=value  api-version=value x-api-version:value
```
...
```bash
 patchSkillAsync  tenantId=value skillId=value  api-version=value x-api-version:value
```
...
```bash
 updateSkillAsync  tenantId=value skillId=value  api-version=value x-api-version:value
```
