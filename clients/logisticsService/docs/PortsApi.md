...
```bash
 createPortAsync  tenantId=value  api-version=value x-api-version:value
```
...
```bash
 deletePortAsync  tenantId=value portId=value  api-version=value x-api-version:value
```
...
```bash
 getPortByIdAsync  tenantId=value portId=value  api-version=value x-api-version:value
```
...
```bash
 getPortsAsync  tenantId=value  api-version=value x-api-version:value
```
...
```bash
 getPortsCountAsync  tenantId=value  api-version=value x-api-version:value
```
...
```bash
 updatePortAsync  tenantId=value portId=value  api-version=value x-api-version:value
```
