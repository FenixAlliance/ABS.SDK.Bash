...
```bash
 createVesselAsync  tenantId=value  api-version=value x-api-version:value
```
...
```bash
 deleteVesselAsync  tenantId=value vesselId=value  api-version=value x-api-version:value
```
...
------------- | ------------- | ------------- | -------------
 **tenantId** | **string** |  | [default to null]
 **vesselId** | **string** |  | [default to null]
 **apiVersion** | **string** |  | [optional] [default to null]
 **xApiVersion** | **string** |  | [optional] [default to null]
...
```bash
 getVesselByIdAsync  tenantId=value vesselId=value  api-version=value x-api-version:value
```
...
```bash
 getVesselsAsync  tenantId=value  api-version=value x-api-version:value
```
...
```bash
 getVesselsCountAsync  tenantId=value  api-version=value x-api-version:value
```
...
```bash
 patchVesselAsync  tenantId=value vesselId=value  api-version=value x-api-version:value
```
...
```bash
 updateVesselAsync  tenantId=value vesselId=value  api-version=value x-api-version:value
```
