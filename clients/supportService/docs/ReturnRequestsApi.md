...
```bash
 createReturnRequestAsync  tenantId=value  api-version=value x-api-version:value
```
...
```bash
 deleteReturnRequestAsync  tenantId=value returnRequestId=value  api-version=value x-api-version:value
```
...
------------- | ------------- | ------------- | -------------
 **tenantId** | **string** |  | [default to null]
 **returnRequestId** | **string** |  | [default to null]
 **apiVersion** | **string** |  | [optional] [default to null]
 **xApiVersion** | **string** |  | [optional] [default to null]
...
```bash
 getReturnRequestAsync  tenantId=value returnRequestId=value  api-version=value x-api-version:value
```
...
```bash
 getReturnRequestsAsync  tenantId=value  api-version=value x-api-version:value
```
...
```bash
 getReturnRequestsCountAsync  tenantId=value  api-version=value x-api-version:value
```
...
```bash
 patchReturnRequestAsync  tenantId=value returnRequestId=value  api-version=value x-api-version:value
```
...
```bash
 updateReturnRequestAsync  tenantId=value returnRequestId=value  api-version=value x-api-version:value
```
