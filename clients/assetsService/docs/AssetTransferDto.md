...
**sourceLocationName** | **string** |  | [optional] [default to null]
**destinationLocationId** | **string** |  | [optional] [default to null]
**destinationLocationName** | **string** |  | [optional] [default to null]
**sourceContactId** | **string** |  | [optional] [default to null]
**sourceContactName** | **string** |  | [optional] [default to null]
**destinationContactId** | **string** |  | [optional] [default to null]
**destinationContactName** | **string** |  | [optional] [default to null]
**sourceDepartmentId** | **string** |  | [optional] [default to null]
**sourceDepartmentName** | **string** |  | [optional] [default to null]
**destinationDepartmentId** | **string** |  | [optional] [default to null]
**destinationDepartmentName** | **string** |  | [optional] [default to null]
